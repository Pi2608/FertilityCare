            ...
            <div key={appointment.id} className="appointment-card">
              ...
              <div className="appointment-actions">
                {appointment.actions.map((action, index) => (
                  <button
                    key={index}
                    className={index === 0 ? "btn-outline" : "btn-danger"}
                  >
                    {action}
                  </button>
                ))}
            ...
            <div className="patient-info">
              ...
              <span
                className={`status-badge ${
                  patientData.status === "Đang điều trị" ? "success" : "default"
                }`}
              >
                {patientData.status}
              </span>
          ...
          <div className="collapsible-sections">
            <div className="section">
              ...
              >
                ...
                <span
                  className={`arrow ${
                    expandedSections.medicalHistory ? "expanded" : ""
                  }`}
                >
                  ▼
                </span>
            ...
            <div className="section">
              ...
              >
                ...
                <span
                  className={`arrow ${
                    expandedSections.familyHistory ? "expanded" : ""
                  }`}
                >
                  ▼
                </span>
            ...
            <div className="section">
              ...
              >
                ...
                <span
                  className={`arrow ${
                    expandedSections.allergies ? "expanded" : ""
                  }`}
                >
                  ▼
                </span>
