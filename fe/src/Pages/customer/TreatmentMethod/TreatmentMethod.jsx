  ...
  return (
    <div className="treatment-method">
      <header className="header">
        ...
        <p>
          Khám phá các phương pháp điều trị hiếm muộn tối ưu, thiết kế để giúc
          bạn xây dựng gia đình mơ ước
        </p>
      </header>
      <section className="introduction">
        <h2>Giải Pháp Điều Trị Hiếm Muộn Tiên Tiến</h2>
        <p>
          Chúng tôi cung cấp nhiều phương pháp điều trị hiếm muộn tiên tiến,
          được cá nhân hóa theo nhu cầu cụ thể của bạn. Đội ngũ chuyên gia của
          chúng tôi sẽ hướng dẫn bạn qua các lựa chọn để tìm ra phương pháp phù
          hợp nhất cho hành trình của bạn.
        </p>
      </section>
