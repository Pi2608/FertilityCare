...
//                 const fetchedDoctors = doctorList.map((doctor, index) => ({
//                     id: index + 1, // hoặc doctor.id nếu backend có trả
//                     name: doctor.name || 'Chưa có tên',
//                     specialty: doctor.specification || 'Chưa cập nhật',
//                     rating: doctor.ratingAvg || 5,
//                     reviews: 0,
    ...
    const fetchAllDoctors = async () => {
        try {
            ...
            if (Array.isArray(doctorList)) {
                ...
                // Tạo danh sách chuyên khoa duy nhất
                const uniqueSpecs = [
                    'Tất cả',
                    ...new Set(
                        fetchedDoctors
