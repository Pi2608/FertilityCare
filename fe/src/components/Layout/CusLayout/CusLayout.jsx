...
const CusLayout = () => {
    ...
    const list = [
        ...
        {name: 'Hồ sơ y tế', path: '/patient-dashboard/medical-records', icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><rect width="15" height="18.5" x="4.5" y="2.75" rx="3.5"/><path d="M8.5 6.755h7m-7 4h7m-7 4H12"/></g></svg>},
        ...
        {name: 'Tài liệu', path: '/patient-dashboard/documents', icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32"><path fill="currentColor" d="M7 5.25v21.5c0 .69.56 1.25 1.25 1.25h15.5c.69 0 1.25-.56 1.25-1.25V13h-5.75A3.25 3.25 0 0 1 16 9.75V4H8.25C7.56 4 7 4.56 7 5.25M24.586 11L18 4.414V9.75c0 .69.56 1.25 1.25 1.25zM27 26.75A3.25 3.25 0 0 1 23.75 30H8.25A3.25 3.25 0 0 1 5 26.75V5.25A3.25 3.25 0 0 1 8.25 2h8.818a3.25 3.25 0 0 1 2.298.952l6.682 6.682c.61.61.952 1.436.952 2.298z"/></svg>},
